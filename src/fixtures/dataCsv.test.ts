...
describe('data.csv against a 40HC', () => {
  ...
  it('packs without violations, and honestly reports what does not fit', () => {
    ...
    expect(utilisation.utilisationRatio).toBeGreaterThan(0.8) // still a highly efficient load
